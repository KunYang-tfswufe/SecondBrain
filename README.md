...
2.  **这本书的DNA是什么？** `是“理论思想”（道）还是“操作手册”（术）？`
3.  **浏览全书地图：** `花3分钟看一遍目录和索引，了解全书的结构和重点。`
4.  **找到黄金章节：** `根据我的目标，哪几章是我必须精读的？用笔圈出来。`
5.  **准备好我的“实验室”：** `代码编辑器、笔记本、草稿纸准备好了吗？`

## 📝 执行你的阅读计划

根据你在清单第2步判断的DNA，选择对应的阅读模式：
...
2.  **【核心循环】项目驱动式阅读:**
    ...
    - **精准学习 & 立即实践:** 只读实现这个小目标需要的内容，理解后立刻在你的项目中把它实现出来。

3.  **【辅助手段】边读边敲，边敲边改:**
    - 对于书中与你目标相关的代码，**绝对不要只看不练！** 把它们应用到你的项目中，然后试着修改它，看看会发生什么。

4.  **【备用策略】当成参考手册:**
    - 这本书就是你的“本地Stack Overflow”。当你遇到具体问题（“怎么连接数据库？”“怎么做用户认证？”）时，把它当作百科全书来查。你不需要从头到尾读。
...
- **忘记是正常的：** 把书放在手边，当你需要的时候，随时回来查阅。好书值得读三遍。
